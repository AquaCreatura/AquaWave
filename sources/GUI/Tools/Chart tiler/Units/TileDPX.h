...
private:
	...
	size_t  max_life_time_ms_ = 10'000;        // обычное время жизни (мс)
	size_t  max_trans_life_time_ms_ = 2'000;   // время жизни в режиме перехода (зум)
	...
	double  base_decay_rate_ = 0.99;   // базовая скорость затухания (1.0 – без затухания)
